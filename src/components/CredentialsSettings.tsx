...
export function CredentialsSettings() {
  ...
  const saveMutation = useMutation({
    mutationFn: async (handle: string) => {
      ...
      if (!handle.trim()) throw new Error("Handle não pode estar vazio");
    ...
    <div className="space-y-6 max-w-2xl">
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Configure seu Handle InfinitePay para gerar cobranças na sua conta
        </p>
      </div>
        ...
        <CardHeader>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <CardDescription>
                Usado para gerar cobranças para seus clientes
              </CardDescription>
            </div>
            {isConfigured && (
        ...
        <CardContent className="space-y-4">
          {!isConfigured ? (
            <>
              ...
              <Button
                onClick={handleSave}
                disabled={saveMutation.isPending || !handleValue.trim()}
                className="w-full"
              >
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-2">
                <Button
                  variant="outline"
                  onClick={() => setHandleValue((credentials as any)?.infinitepay_handle || "")}
                  className="flex-1"
                >
                  Atualizar Handle
                </Button>
